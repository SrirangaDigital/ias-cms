...
class viewHelper extends View {
	...
	public function linkArticle($data = array(), $anchorText = 'Fulltext PDF', $action = 'view', $hoverText = '') {
        ...
        echo ' title="' . $hoverText . '" target="_blank" class="text-blue download-article" href="'. BASE_URL . 'article/fulltext/' . $data->journal . '/' . $data->volume . '/' . $data->issue . '/' . $data->page . '">' . $anchorText . '</a>';
    }
